...
namespace JLib {
    ...
    // MonotonicNs now lives in Clock.cpp, over the OS clock rather than chrono. See Clock.h for
    // why there is no clock thread and why coarse and exact are two reads of one timeline.
...
#define CREATE_WAITABLE_TIMER_HIGH_RESOLUTION 0x00000002
    ...
    struct TimerQueue::Impl {
        ...
        void LaunchPeriodic(PeriodicRecord* r) {
            ...
            Task* t = s.CreateTask(&RunPeriodic, r);
            ...
            const bool ok = s.PushTo(t, CorePref::Any, true);
    ...
    Periodic Periodic::Start(int64_t intervalNs, PeriodicFn fn, void* ctx, int64_t firstDelayNs) {
